...
std::tuple<std::unique_ptr<Value>, ASTEvaluateResult> evalBinaryOp(
    const std::shared_ptr<BinaryExpr>& binaryOp,
    Int64Value* lhsValue,
    Int64Value* rhsValue,
    const std::shared_ptr<DiagnosticHandler>& diag)
{
    ...
    switch (op) {
    case BinaryExprKind::Assign: return staticEvaluation<Int64Value>(rhs);
    case BinaryExprKind::Add: return staticEvaluation<Int64Value>(lhs + rhs);
    case BinaryExprKind::Subtract: return staticEvaluation<Int64Value>(lhs - rhs);
    case BinaryExprKind::Multiply: return staticEvaluation<Int64Value>(lhs * rhs);
    case BinaryExprKind::Divide: return staticEvaluation<Int64Value>(lhs / rhs);
    case BinaryExprKind::Mod: return staticEvaluation<Int64Value>(lhs % rhs);
    case BinaryExprKind::GreaterThan: return staticEvaluation<BoolValue>(lhs > rhs);
    case BinaryExprKind::GreaterThanOrEqual: return staticEvaluation<BoolValue>(lhs >= rhs);
    case BinaryExprKind::LessThan: return staticEvaluation<BoolValue>(lhs < rhs);
    case BinaryExprKind::LessThanOrEqual: return staticEvaluation<BoolValue>(lhs <= rhs);
    case BinaryExprKind::Equal: return staticEvaluation<BoolValue>(lhs == rhs);
    case BinaryExprKind::NotEqual: return staticEvaluation<BoolValue>(lhs != rhs);
    case BinaryExprKind::LogicalOr: return staticEvaluation<BoolValue>(lhs || rhs);
    case BinaryExprKind::LogicalAnd: return staticEvaluation<BoolValue>(lhs && rhs);
    case BinaryExprKind::NullCoalescing: break;
    }

    auto type = BuiltinType::toString(BuiltinTypeKind::Int);
    diag->error(
        "error: invalid operands of types '" + type + "' and '" + type + "' to binary 'operator" +
        BinaryExpr::toString(op) + "'");
    ...
    const std::shared_ptr<DiagnosticHandler>& diag)
{
    ...
    switch (op) {
    case BinaryExprKind::Assign: return staticEvaluation<DoubleValue>(rhs);
    case BinaryExprKind::Add: return staticEvaluation<DoubleValue>(lhs + rhs);
    case BinaryExprKind::Subtract: return staticEvaluation<DoubleValue>(lhs - rhs);
    case BinaryExprKind::Multiply: return staticEvaluation<DoubleValue>(lhs * rhs);
    case BinaryExprKind::Divide: return staticEvaluation<DoubleValue>(lhs / rhs);
    case BinaryExprKind::GreaterThan: return staticEvaluation<BoolValue>(lhs > rhs);
    case BinaryExprKind::GreaterThanOrEqual: return staticEvaluation<BoolValue>(lhs >= rhs);
    case BinaryExprKind::LessThan: return staticEvaluation<BoolValue>(lhs < rhs);
    case BinaryExprKind::LessThanOrEqual: return staticEvaluation<BoolValue>(lhs <= rhs);
    ...
    const std::shared_ptr<DiagnosticHandler>& diag)
{
    ...
    switch (op) {
    case BinaryExprKind::Assign: return staticEvaluation<BoolValue>(rhs);
    case BinaryExprKind::Equal: return staticEvaluation<BoolValue>(lhs == rhs);
    case BinaryExprKind::NotEqual: return staticEvaluation<BoolValue>(lhs != rhs);
    case BinaryExprKind::LogicalOr: return staticEvaluation<BoolValue>(lhs || rhs);
    case BinaryExprKind::LogicalAnd: return staticEvaluation<BoolValue>(lhs && rhs); break;
    default: break;
    }
    ...
    const std::shared_ptr<DiagnosticHandler>& diag)
{
    ...
    switch (op) {
    case BinaryExprKind::Assign: return staticEvaluation<StringValue>(rhs);
    case BinaryExprKind::Add: return staticEvaluation<StringValue>(lhs + rhs);
    case BinaryExprKind::Equal: return staticEvaluation<BoolValue>(lhs == rhs);
    case BinaryExprKind::NotEqual: return staticEvaluation<BoolValue>(lhs != rhs); break;
    default: break;
    }
...
std::tuple<std::unique_ptr<Value>, ASTEvaluateResult> evaluateBinaryOp(
    const std::shared_ptr<BinaryExpr>& binaryOp, const std::shared_ptr<DiagnosticHandler>& diag)
{
...
std::tuple<std::unique_ptr<Value>, ASTEvaluateResult> evaluateImplicitCast(
    const std::shared_ptr<ImplicitConversionExpr>& expr,
    const std::shared_ptr<DiagnosticHandler>& diag)
{
    ...
    const std::shared_ptr<Expr>& expr, const std::shared_ptr<DiagnosticHandler>& diag)
{
    ...
    if (auto e = std::dynamic_pointer_cast<ImplicitConversionExpr>(expr)) {
