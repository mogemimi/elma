...
void PrettyPrinter::writeString(const std::string& s)
{
    output += s;
}

std::tuple<NodeKind, bool> PrettyPrinter::getOuterNodeKind() const
{
...
bool PrettyPrinter::begin(std::shared_ptr<Node> node)
{
    outerStack.push_back(node->getKind());
    return true;
}

void PrettyPrinter::end(std::shared_ptr<Node> node)
{
    assert(!outerStack.empty());
    outerStack.pop_back();
}

void PrettyPrinter::visit(std::shared_ptr<Identifier> ident)
{
    writeString(ident->getName());
    ASTVisitor::visit(ident);
}

void PrettyPrinter::visit(std::shared_ptr<VarDecl> decl)
{
...
void PrettyPrinter::visit(std::shared_ptr<BindingDecl> decl)
{
    AST::walk(this, decl->getIdentifier());
}

void PrettyPrinter::visit(std::shared_ptr<DecompositionDecl> decl)
{
    writeString(VarDecl::getSpecifierString(decl->getSpecifier()));
    writeString(" (");
...
void PrettyPrinter::visit(std::shared_ptr<FuncDecl> decl)
{
    writeString("func ");
...
void PrettyPrinter::visit(std::shared_ptr<ParamDecl> decl)
{
    AST::walk(this, decl->getIdentifier());
...
void PrettyPrinter::visit(std::shared_ptr<ClassDecl> decl)
{
    writeString("class ");
    AST::walk(this, decl->getIdentifier());
    writeString(" {");
...
void PrettyPrinter::visit(std::shared_ptr<IntegerLiteral> expr)
{
    writeString(std::to_string(expr->getValue()));
    ASTVisitor::visit(expr);
}

void PrettyPrinter::visit(std::shared_ptr<DoubleLiteral> expr)
{
    writeString(std::to_string(expr->getValue()));
    ASTVisitor::visit(expr);
}

void PrettyPrinter::visit(std::shared_ptr<BoolLiteral> expr)
{
    writeString(expr->getValue() ? "true" : "false");
    ASTVisitor::visit(expr);
}

void PrettyPrinter::visit(std::shared_ptr<StringLiteral> expr)
{
    writeString('"' + expr->getValue() + '"');
    ASTVisitor::visit(expr);
}

void PrettyPrinter::visit(std::shared_ptr<NullLiteral> expr)
{
    writeString("null");
    ASTVisitor::visit(expr);
}

void PrettyPrinter::visit(std::shared_ptr<ParenExpr> expr)
{
    writeString("(");
...
void PrettyPrinter::visit(std::shared_ptr<UnaryExpr> expr)
{
...
void PrettyPrinter::visit(std::shared_ptr<BinaryExpr> expr)
{
...
void PrettyPrinter::visit(std::shared_ptr<AssignExpr> expr)
{
    AST::walk(this, expr->getLHS());
...
void PrettyPrinter::visit(std::shared_ptr<ConditionalOperator> expr)
{
...
void PrettyPrinter::visit(std::shared_ptr<NullConditionalOperator> expr)
{
    AST::walk(this, expr->getTrueExpr());
}

void PrettyPrinter::visit(std::shared_ptr<MemberExpr> expr)
{
...
void PrettyPrinter::visit(std::shared_ptr<SubscriptExpr> expr)
{
    AST::walk(this, expr->getBase());
...
void PrettyPrinter::visit(std::shared_ptr<ArrayLiteral> expr)
{
    writeString("[");
...
void PrettyPrinter::visit(std::shared_ptr<MapEntry> expr)
{
...
void PrettyPrinter::visit(std::shared_ptr<MapLiteral> expr)
{
    writeString("[");
...
void PrettyPrinter::visit(std::shared_ptr<CallExpr> expr)
{
...
void PrettyPrinter::visit(std::shared_ptr<FuncLiteral> expr)
{
    writeString("func ");
...
void PrettyPrinter::visit(std::shared_ptr<CompoundStmt> stmt)
{
...
void PrettyPrinter::visit(std::shared_ptr<ReturnStmt> stmt)
{
    writeString("return");
...
void PrettyPrinter::visit(std::shared_ptr<DeferStmt> stmt)
{
    writeString("defer ");
    writeString("{\n");
...
void PrettyPrinter::visit(std::shared_ptr<IfStmt> stmt)
{
    writeString("if (");
...
void PrettyPrinter::visit(std::shared_ptr<WhileStmt> stmt)
{
    writeString("while (");
...
void PrettyPrinter::visit(std::shared_ptr<ForStmt> stmt)
{
    writeString("for (");
...
void PrettyPrinter::visit(std::shared_ptr<ForEachStmt> stmt)
{
    // TODO: Not implemented
...
void PrettyPrinter::visit(std::shared_ptr<SimpleIdentTypeRepr> repr)
{
    AST::walk(this, repr->getIdentifier());
}

void PrettyPrinter::visit(std::shared_ptr<GenericIdentTypeRepr> repr)
{
    AST::walk(this, repr->getIdentifier());
...
void PrettyPrinter::visit(std::shared_ptr<OptionalTypeRepr> repr)
{
